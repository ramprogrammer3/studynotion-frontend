    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          <h2 className=" text-[20px] md:text-[1.875rem] font-semibold leading-[2.375rem] text-richblack-5">
            Choose new password
          </h2>
          <p className="my-4 text-sm md:text-[1.125rem] leading-[1.625rem] text-richblack-100">
          ...
          <div className="mt-6 flex items-center justify-between">
            <Link to="/login">
              <p className="flex items-center gap-x-2 text-richblack-5 text-sm md:text-[20px]">
                {" "}
